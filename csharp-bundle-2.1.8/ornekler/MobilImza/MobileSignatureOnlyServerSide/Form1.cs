...
namespace MobileSignatureOnlyServerSide
{
    public partial class Form1 : Form
    {
        ...
        private void btnSign_Click(object sender, EventArgs e)
        {
            ...
            ValidationPolicy readValidationPolicy = PolicyReader.readValidationPolicy(new FileStream("../../../../config/certval-policy.xml", FileMode.Open, FileAccess.Read));
            ...
            //GUI'den seçtir
            SignatureAlg signatureAlg = SignatureAlg.RSA_SHA1;

            MobileSigner mobileSigner = new MobileSigner(emsspClientConnector, phoneNumberAndOperator, signerCert, "Dosya imzalanacak", signatureAlg.getName());

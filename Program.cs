...
namespace ProgramNameSpace
{
    static class Program
    {
        ...
        public static string ParamSQLServer = "192.168.0.5"; // "127.0.0.1";

        public static string ParamSQLUser;
        public static string ParamSQLPassword;
        public static string ParamSQLDB;
        ...
        public static string ImzalanacakVeriTipi = "";
        public static string[] KayitBilgisi;
        public static utils.SmartCardManagerKimlikNodanSec mSCManager;
        ...
        {   // dll dosyalari 
            ...
            else
            {
                ...
                if (args.Length > 18) { ParamSQLDB = args[18]; }
                if (args.Length > 19) { ParamSQLUser = args[19]; }
                if (args.Length > 20) { ParamSQLPassword = args[20]; }
            }

            ParamXML = ParamXML.Replace("^", ""); // varsa ^ karakterini temizle
            ParamPath = ParamPath.Replace("\"", ""); // varsa " karakterini temizle 

            if (ParamSQLServer == "") { ParamSQLServer = "192.168.0.5"; }
            ParamSQLUser = "yyyyyyy";
            if (ParamSQLDB == "") { ParamSQLDB = "hbysdb"; }

            ParamSQLPassword = "xxxxxxx";
            KayitBilgisi = Program.ParamXML.Split('|');
